...
class GETRequestTests(unittest.TestCase):
    def setUp(self):
        self.request1 = HTTPRequest("https://example.com", "GET", 1.1, None, None, 'Firefox')
        self.request2 = HTTPRequest("https://example.com", "GET", 1.1, "Connection: Keep-Alive", None, None)
        self.request3 = HTTPRequest("https://example.com", "GET", 1.1, None, "Test message", 'Firefox')
...
class POSTRequestTests(unittest.TestCase):
    def setUp(self):
        self.request1 = HTTPRequest("https://example.com", "POST", 1.1, None, "Test message", 'Firefox')
        self.request2 = HTTPRequest("https://example.com", "POST", 1.1, "Connection: Keep-Alive, Accept-Language: fr",
                                    "Test message", None)
        self.request3 = HTTPRequest("https://example.com", "POST", 1.1, None, None, 'Firefox')
...
class HEADRequestTests(unittest.TestCase):
    def setUp(self):
        self.request1 = HTTPRequest("https://example.com", "HEAD", 1.1, None, None, 'Firefox')
        self.request2 = HTTPRequest("https://example.com", "HEAD", 1.1, "Connection: Keep-Alive, "
                                                                        "Accept-Language: fr", None, None)
        self.request3 = HTTPRequest("https://example.com", "HEAD", 1.1, None, "Test message", 'Firefox')
...
class PUTRequestTests(unittest.TestCase):
    def setUp(self):
        self.request1 = HTTPRequest("https://example.com", "PUT", 1.1, None, "Test message", 'Firefox')
        self.request2 = HTTPRequest("https://example.com", "PUT", 1.1, "Connection: Keep-Alive, Accept-Language: fr",
                                    "Test message", None)
        self.request3 = HTTPRequest("https://example.com", "PUT", 1.1, None, None, 'Firefox')
